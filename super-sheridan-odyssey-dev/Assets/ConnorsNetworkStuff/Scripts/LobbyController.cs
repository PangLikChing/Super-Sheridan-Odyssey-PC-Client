...
public class LobbyController : MonoBehaviourPunCallbacks
{
    ...
    private string _lastCreatedRoom;
    ...
    void Update()
    {
        ...
        //if (existingRoomName == _listOfRooms.options[0].text)
        //{
        //    _listOfRooms.ClearOptions();
        //    existingRoomName = "";
        //}
        ...
        //{
        //    //existingRoomName
        //    if (existingRoomName == _listOfRooms.options[i].text)
        //    {
        //        _listOfRooms.ClearOptions();
        //        existingRoomName = "";
        //    }
        ...
        for (int i = 0; i < roomList.Count; i++)
        {
            ...
            else
            {
               ...
               // Debug.Log("Before converting to string " + info);
                ...
                workingList.Add(existingRoomName);
                _lastCreatedRoom = existingRoomName;
            }
        }
